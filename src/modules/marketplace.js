...
export const getMarketplaceGeneralInfo = () => {
  return (dispatch, getState) => {
    ...
    Promise.all([
      ...
      const [purchasedProducts, productsAvaliable, totalPurchases, totalTags] =
        data;
      ...
      dispatch({
        ...
        payload: {
          purchasedProducts: purchasedProducts
            ? purchasedProducts.numberOfPurchases
            : 0,
          productsAvaliable: productsAvaliable
            ? productsAvaliable.numberOfGoods
            : 0,
          totalPurchases: totalPurchases ? totalPurchases.purchases.length : 0,
          totalTags: totalTags ? totalTags.numberOfTags : 0,
          totalPurchasedProducts: totalPurchases
