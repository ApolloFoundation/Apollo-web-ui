...
class Transaction extends React.Component {
  ...
  getPhasingTransactionInfo = async () => {
    const phasing = await getPhasingTransactionVoters({
          ...
          <>
            ...
            <td>
              ...
              <button
                ...
                className="btn btn-blue-link"
                onClick={() =>
                  setBodyModalParamsAction("INFO_ACCOUNT", recipient)
                }
              >
                {recipientRS}
              </button>
            ...
            <td className="align-right">
              {!isUnconfirmed ? (
                <button
                  type="button"
                  className="btn btn-blue-link text-align-right"
                  onClick={this.getBlock.bind(this, "INFO_BLOCK", height)}
                >
                  {height}
                </button>
              ) : (
