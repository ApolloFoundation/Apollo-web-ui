...
export default function Currency(props) {
  ...
  const isDisable =
    ...
    !actualBlock ||
    (types.includes("RESERVABLE") && isReserveDisable);
    ...
    <tr>
      ...
      <td className="align-right">
        <div className="btn-box inline">
          <Link to={`/exchange-booth/${code}`} className="btn btn-default">
            Exchange
          </Link>
          <button
            type="button"
            onClick={() =>
              dispatch(setBodyModalParamsAction("RESERVE_CURRENCY", props))
            }
