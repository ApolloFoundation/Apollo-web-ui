...
export default function Currency(props) {
  ...
  return (
    <tr>
      ...
      <td className="align-right">{bigIntToString(bigIntDecimalsDivision(currentSupply, decimals))}</td>
      <td className="align-right">{bigIntToString(bigIntDecimalsDivision(maxSupply, decimals))}</td>
