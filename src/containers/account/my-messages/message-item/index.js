...
const mapDispatchToProps = (dispatch) => ({
  ...
  tryToDecryptMessageAPL: (data, options) =>
    dispatch(crypto.tryToDecryptMessageAPL(data, options)),
      ...
      <tr>
        ...
        <td>
          <button
            ...
            onClick={() => setBodyModalParamsAction("INFO_ACCOUNT", sender)}
          >
            {senderRS}
          </button>
        </td>
        <td>
          <button
            className="blue-link-text"
            onClick={() => setBodyModalParamsAction("INFO_ACCOUNT", recipient)}
          >
            {recipientRS}
          </button>
        </td>
        <td>
          ...
          {isDescrypted && decryptedMessage && decryptedMessage !== "false" && (
            <div>
          ...
          {!isDescrypted && !publicMessage && !decryptedMessage && (
            <>
              <a onClick={() => setBodyModalParamsAction("DECRYPT_MESSAGES")}>
