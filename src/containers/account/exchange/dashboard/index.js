                ...
                <div className="exchange page-body container-fluid pl-0">
                    <div className={'row'}>
                        <div className={'col-md-12 pr-0 pb-3'}>
                            <InfoBox info>
                                Please, notice - this is the first version on Apollo Exchange. Functionality of trading will be delivered in Q2 2019. At the moment you can deposit in ETH and PAX.
