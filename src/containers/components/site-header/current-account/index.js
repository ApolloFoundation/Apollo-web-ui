...
const CurrentAccount = ({ accountRS, account, publicKey, contacts, isContacts, isActive, setBodyModalParamsAction, history, switchAccountAction, forgingStatus }) => {

    const [isContactsLocal, setIsContacts] = useState(null)
