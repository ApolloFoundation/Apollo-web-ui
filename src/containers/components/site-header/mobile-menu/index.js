    ...
    <>
      <Accordion>
          ...
          <div className={`mobile-nav-item`}>
            ...
            <AccordionItemPanel>
              <div className="item-dropdown">
                ...
                <NavLink exact={true} activeClassName="active" to="/ledger">
                  Account ledger
                </NavLink>
                <NavLink
                  exact={true}
            ...
            <AccordionItemPanel>
              <div className="item-dropdown">
                ...
                <a
                  ...
                  onClick={() =>
                    dispatch(setBodyModalParamsAction("ISSUE_ASSET"))
                  }
                >
                  Issue assets
                </a>
          ...
          <div className={"mobile-nav-item"}>
            ...
            <AccordionItemPanel>
              <div className="item-dropdown">
                ...
                <NavLink to="/exchange-history-currency">
                  Exchange history
                </NavLink>
                <NavLink to="/transfer-history-currency">
                  Transfer history
                </NavLink>
                <a
                  id="open-issue-currency-mobile"
                  onClick={() =>
                    dispatch(setBodyModalParamsAction("ISSUE_CURRENCIES"))
                  }
                >
                  Issue Currencies
                </a>
        ...
        {smartContractAddress !== "#" && (
          <NavLink
            to={{ pathname: smartContractAddress }}
            target="_blank"
            className="w-100"
          >
            <AccordionItem>
              <div className={"mobile-nav-item"}>
                <AccordionItemHeading className={"text"}>
                  <AccordionItemButton>
                    <i className="zmdi zmdi-collection-text left" />
                    Contracts
                    <span className="arrow" />
                  </AccordionItemButton>
                </AccordionItemHeading>
        ...
        {process.env.REACT_APP_DFS_URL && (
          <NavLink
            to={{ pathname: process.env.REACT_APP_DFS_URL }}
            target="_blank"
            className="w-100"
          >
            <AccordionItem>
              <div className={"mobile-nav-item"}>
                <AccordionItemHeading className={"text"}>
                  <AccordionItemButton>
                    <i className="zmdi zmdi-storage left" />
                    Distributed file storage <span className="arrow" />
                  </AccordionItemButton>
                </AccordionItemHeading>
              </div>
            </AccordionItem>
            ...
            <AccordionItemPanel>
              <div className="item-dropdown">
                ...
                <a
                  ...
                  onClick={() =>
                    dispatch(setBodyModalParamsAction("ISSUE_POLL"))
                  }
                >
                  Create poll
                </a>
            ...
            <AccordionItemPanel>
              <div className="item-dropdown">
                ...
                <a
                  ...
                  onClick={() =>
                    dispatch(setBodyModalParamsAction("ISSUE_FILE_UPLOAD"))
                  }
                >
                  File upload
                </a>
          ...
          <div className={"mobile-nav-item"}>
            ...
            <AccordionItemPanel>
              <div className="item-dropdown">
                ...
                <NavLink to="/my-products-for-sale">
                  My products for sale
                </NavLink>
                ...
                <a
                  ...
                  onClick={() =>
                    dispatch(setBodyModalParamsAction("LIST_PRODUCT_FOR_SALE"))
                  }
                >
            ...
            <AccordionItemPanel>
              <div className="item-dropdown">
                ...
                <a
                  ...
                  onClick={() =>
                    dispatch(setBodyModalParamsAction("ISSUE_CREATE_SHUFFLING"))
                  }
                >
                  Create shuffling
                </a>
        ...
        <AccordionItem>
          <div className={"mobile-nav-item"}>
            <AccordionItemHeading
              className={`text ${getNavLinkClass(["/aliases", "/my-aliases"])}`}
            >
              <AccordionItemButton>
                <i className="zmdi zmdi-comments" />
                Search Aliases
