...
class ModalBody extends React.Component {
  ...
  loadValues = (values) => {
    if (values) {
      ...
      if (
        modalsHistory[modalsHistory.length - 1] &&
        modalsHistory[modalsHistory.length - 1].value
      ) {
      ...
      <BackForm
        ...
        render={({
          ...
          <form
            onSubmit={submitForm}
            className={`${
              isPour ? "" : "modal-form modal-send-apollo"
            } ${className}`}
          >
                ...
                {marketplace && (
                  <>
                    ...
                    <div className="form-group mb-15">
                      <label>Price:</label>
                      <div className="price">
                        {marketplace.priceATM / this.props.decimals}{" "}
                        {this.props.ticker}
                      </div>
                    </div>
                    ...
                    {marketplace.description && (
                      <div className="form-group mb-15">
                        ...
                        <div>{marketplace.description}</div>
                      </div>
                    )}
                  </>
                )}
  ...
  render() {
    ...
    return isPour ? (
      ...
      <div
        className={`modal-box ${isWide ? "wide" : ""} ${
          isXWide ? "x-wide" : ""
        }`}
      >
        {this.form()}
