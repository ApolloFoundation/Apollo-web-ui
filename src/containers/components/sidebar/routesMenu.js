...
export const exchangeMenu = {
  ...
  children: [
    ...
    {
      className: "/trade-history-exchange",
      to: "/trade-history-exchange",
      label: "Trade history",
      icon: "zmdi-chart",
    },
  ],
...
export const currencySystemMenu = {
  ...
  additionalChildren: {
    ...
    label: "Issue currencies",
    modalType: "ISSUE_CURRENCIES",
  },
  children: [
    {
      className: "/my-currencies",
      to: "/my-currencies",
      label: "My currencies",
      icon: "zmdi-money",
    },
    {
      className: "/transfer-history-currency",
      to: "/transfer-history-currency",
      label: "Transfer history",
      icon: "zmdi-money",
    },
    {
      className: "/exchange-history-currency",
      to: "/exchange-history-currency",
...
export const votingSystemMenu = {
  ...
  children: [
    {
      className: "/finished-polls",
      to: "/finished-polls",
      label: "Finished polls",
      icon: "zmdi-star",
    },
    {
      className: "/followed-polls",
      to: "/followed-polls",
      label: "Followed polls",
      icon: "zmdi-star",
    },
    {
      className: "/my-votes",
...
export const marketplaceMenu = {
  ...
  additionalChildren: {
    ...
    label: "List product for sale",
    modalType: "LIST_PRODUCT_FOR_SALE",
  },
  children: [
    {
    ...
    {
      className: "/my-products-for-sale",
      to: "/my-products-for-sale",
      label: "My products for sale",
      icon: "zmdi-label",
    },
    {
      className: "/my-pending-orders",
      to: "/my-pending-orders",
      label: "My pending orders",
      icon: "zmdi-label",
    },
    {
      className: "/my-completed-orders",
      to: "/my-completed-orders",
...
export const coinShufflingMenu = {
  ...
  additionalChildren: {
    ...
    label: "Create shuffling",
    modalType: "ISSUE_CREATE_SHUFFLING",
  },
  children: [
    {
      className: "/finished-shuffling",
      to: "/finished-shuffling",
      label: "Finished shuffling",
      icon: "zmdi-circle-o",
    },
    {
      className: "/my-shuffling",
      to: "/my-shuffling",
      label: "My shuffling",
      icon: "zmdi-circle-o",
    },
