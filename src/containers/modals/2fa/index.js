              ...
              <div className="form-group-app">
                ...
                <div className="form-title">
                  {this.props.modalsHistory.length > 1 && (
                    <div
                      className="backMy"
                      onClick={() => this.props.openPrevModal()}
                    />
                  )}
                ...
                <div className="form-group mb-15">
                  ...
                  <div>
                    {this.props.modalData && this.props.modalData.qrCodeUrl && (
                ...
                <InfoBox attentionLeft>
                  ...
                  2FA is a feature for Vault addresses only, and will not add a
                  second factor authentication to a standard address.
                </InfoBox>
                <div className="form-group mb-15">
                  <label>Your generated secret word:</label>
                  <div>
                    <InfoBox info>
                      {this.props.modalData && this.props.modalData.secret}
                    </InfoBox>
                  </div>
                </div>
                <div className="form-group mb-15">
