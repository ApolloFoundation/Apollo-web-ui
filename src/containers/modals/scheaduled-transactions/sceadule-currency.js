...
const mapDispatchToProps = (dispatch) => ({
  getCurrencyAction: (requestParams) =>
    dispatch(getCurrencyAction(requestParams)),
  setBodyModalParamsAction: (requestType, data) =>
    dispatch(setBodyModalParamsAction(requestType, data)),
...
class ScheaduleCurrency extends React.Component {
  handleFormSubmit = async (values) => {
    ...
    this.props.processForm(
      values,
      "scheduleCurrencyBuy",
      "Schedule currency has been submitted.",
      () => {
  ...
  getCurrency = async (reqParams, setValue) => {
    ...
    if (result) {
      this.setState({
        ...
        currencyDecimals: result.decimals,
      });
                  ...
                  <div className="row form-group-white">
                    ...
                    <div className="col-sm-9">
                      <div className="iconned-input-field">
                        <AccountRS field={"offerIssuer"} setValue={setValue} />
                      </div>
                    </div>
                  </div>
                </div>
