...
const mapDispatchToProps = (dispatch) => ({
  ...
  getDGSGoodAction: (requestParams) =>
    dispatch(getDGSGoodAction(requestParams)),
  ...
  async handleFormSubmit(values) {
    ...
    if (res.errorCode) {
      ...
      NotificationManager.success(
        "The marketplace item has been deleted successfully!",
        null,
        5000
      );
    }
    ...
    return (
      <ModalBody
        ...
        marketplace={{
          ...
          }requestType=downloadPrunableMessage&transaction=${
