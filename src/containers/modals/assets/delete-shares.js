...
class DeleteShares extends React.Component {
  ...
  handleFormSubmit = async (values) => {
    values = {
      ...
      quantityATU:
        values.quantityATU * Math.pow(10, this.props.modalData.decimals),
    };

    this.props.processForm(
      values,
      "deleteAssetShares",
      "Delete asset request has been submitted!",
      () => {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        <Text
          defaultValue={this.props.modalData.assetID}
          type="hidden"
          field={"asset"}
        />
        ...
        <TextualInputComponent
          label={"Asset"}
          text={`${
            this.props.modalData.assetName
          } - ${this.props.modalData.quantityATU.toLocaleString("en", {
