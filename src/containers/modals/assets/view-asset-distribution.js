                      ...
                      this.state.assets.map((el, index) => {
                        return (
                          <tr>
                            ...
                            <td>
                              {el.quantityATU /
                                Math.pow(10, this.props.modalData.decimals)}
                            </td>
                            <td className="align-right">
                              {(el.quantityATU /
                                this.props.modalData.totalAvailable) *
                                100}{" "}
                              %
                            </td>
                          </tr>
...
const mapDispatchToProps = (dispatch) => ({
  getAccountAssetsAction: (requestParams) =>
    dispatch(getAccountAssetsAction(requestParams)),
  getAccountAssetAction: (reqParams) =>
    dispatch(getSpecificAccountAssetsAction(reqParams)),
