...
const mapDispatchToProps = (dispatch) => ({
  ...
  validatePassphrase: (passPhrase) =>
    dispatch(crypto.validatePassphrase(passPhrase)),
  getAccountIdAsyncApl: (passPhrase) =>
    dispatch(crypto.getAccountIdAsyncApl(passPhrase)),
  getAccountDataAction: (reqParams) =>
    dispatch(getAccountDataAction(reqParams)),
});
    ...
    this.setState({ isValidating: false }, () => {
      setTimeout(() => {
        const element = document.querySelector(
          "#modal-window-container .modal-box"
        );
                                      ...
                                      <div>
                                        <InfoBox info>
                                          <ul className={"marked-list"}>
                                            ...
                                            <li>
                                              You can log in using your Account
                                              ID.
                                            </li>
                                            <li>
                                              The wallet is encrypted (via
                                              Secret Key) on one device.
                                            </li>
                                            <li>
                                              You can export/import your Secret
                                              Key to use on other devices.
                                            </li>
                                            <li>
                                              2FA works from any device when you
                                              use your Vault.
                                            </li>
                                            <li>
                                              If you lose your device or
                                              uninstall the wallet before
                                              exporting your secret file, you
                                ...
                                <React.Fragment>
                                        ...
                                        <div>
                                          <InfoBox info>
                                            <ul className={"marked-list"}>
                                              ...
                                              <li>
                                                You can export/import your
                                                Secret Key to use on other
                                                devices.
                                              </li>
                                              <li>
                                                2FA works from any device when
                                                you use your Vault.
                                              </li>
                                              <li>
                                                If you lose your device or
                                  ...
                                  <div className="input-group-app display-block offset-bottom">
                                    <div className="row">
                                      ...
                                      <div className="col-md-12">
                                        ...
                                        >
                                          <InfoBox danger>
                                            <strong>Remember</strong> to store
                                            your Account ID and secret phrase in
                                            a secured place. Make sure to write
                                            down this secret phrase and store it
                                            securely (the secret phrase is order
                                            and case sensitive). This secret
                                  ...
                                  <div className="input-group-app display-block offset-bottom">
                                    <div className="row">
                                      <div className="col-md-12 mb-15">
                                        <label>
                                          Your randomly generated secret phrase
                                          is:
                                        </label>
                                      </div>
                                      <div className="col-md-12">
                                                ...
                                                <CopyToClipboard
                                                  ...
                                                  onCopy={() => {
                                                    NotificationManager.success(
                                                      "The account data has been copied to clipboard."
                                                    );
                                                  }}
                                                >
                                                  <button
                                  ...
                                  <div className="input-group-app display-block offset-bottom">
                                    <div className="row">
                                      <div className="col-md-12">
                                        ...
                                        />
                                        <label>
                                          I wrote down my Account ID, Secret
                                          phrase. It is now stored in a secured
                                          place
                                        </label>
                                      </div>
                                    </div>
                                    ...
                                    <button
                                      onClick={() => {
                                        if (!getFormState().values.losePhrase) {
                                          NotificationManager.error(
                                            "You have to verify that you stored your private data",
                                            "Error",
                                            7000
                                          );
                                          return;
                                    ...
                                    <div className="col-md-12">
                                      <div>
                                        <InfoBox info>
                                          <ul>
                                            <li>
                                              You can log in to this wallet
                                              using only your secret phrase
                                            </li>
                                            <li>
                                              Available to use from any device
                                            </li>
                                            <li>
                                              2FA is available only on the
                                  ...
                                  <div className="input-group-app display-block offset-bottom">
                                    <div className="row">
                                      <div className="col-md-12">
                                        ...
                                        />
                                        <label>
                                          I wrote down my secret phrase. It is
                                          now stored in a secured place.
                                        </label>
                                      </div>
                                    </div>
                                  </div>
