...
class InfoAccount extends React.PureComponent {
  ...
  static getDerivedStateFromProps(props, state) {
    if (
      ...
      (!state.account || props.modalData !== state.modalData)
    ) {
                ...
                {this.state.account && (
                  <React.Fragment>
                    ...
                    {this.props.account !== this.state.account.account && (
                      <Button
                        onClick={() =>
                          this.props.switchAccountAction(
              ...
              <TabulationBody>
                <TabContaier sectionName="Transactions">
                  <CustomTable
                    ...
                    previousHendler={() =>
                      this.onPaginate(
                        "transactions",
                        this.state.pagination.transactions - 1
                      )
                    }
                    nextHendler={() =>
                      this.onPaginate(
                ...
                <TabContaier sectionName="Ledger">
                  <CustomTable
                    ...
                    previousHendler={() =>
                      this.onPaginate(
                        "account_ledger",
                        this.state.pagination.account_ledger - 1
                      )
                    }
                    nextHendler={() =>
                      this.onPaginate(
                ...
                <TabContaier sectionName="Trade history">
                  <CustomTable
                    ...
                    tableData={
                      this.state.trades ? this.state.trades.trades : null
                    }
                    isPaginate
                    ...
                    previousHendler={() =>
                      this.onPaginate(
                        "trades",
                        this.state.pagination.trades - 1
                      )
                    }
                    nextHendler={() =>
                      this.onPaginate(
                ...
                <TabContaier sectionName="Currencies">
                  <CustomTable
                    ...
                    previousHendler={() =>
                      this.onPaginate(
                        "currencies",
                        this.state.pagination.currencies - 1
                      )
                    }
                    nextHendler={() =>
                      this.onPaginate(
                ...
                <TabContaier sectionName="Marketplace">
                  <CustomTable
                    ...
                    previousHendler={() =>
                      this.onPaginate("goods", this.state.pagination.goods - 1)
                    }
                    nextHendler={() =>
                      this.onPaginate("goods", this.state.pagination.goods + 1)
                    }
                ...
                <TabContaier sectionName="Aliases">
                  <CustomTable
                    ...
                    tableData={
                      this.state.aliases ? this.state.aliases.aliases : null
                    }
                    isPaginate
                    ...
                    previousHendler={() =>
                      this.onPaginate(
                        "aliases",
                        this.state.pagination.aliases - 1
                      )
                    }
                    nextHendler={() =>
                      this.onPaginate(
...
const mapDispatchToProps = (dispatch) => ({
  ...
  getAccountAction: (requestParams) =>
    dispatch(getAccountAction(requestParams)),
  switchAccountAction: (requestParams, history) =>
    dispatch(switchAccountAction(requestParams, history)),
  getTransactionsAction: (requestParams) =>
    dispatch(getTransactionsAction(requestParams)),
});

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(InfoAccount)
);
