...
class SellAliasForm extends React.Component {
  ...
  render() {
    const { setValue, handleSellAlias, closeModal, alias, onFocus, ticker } =
      this.props;

    return (
      <>
        <TabulationBody className={"p-0"} onFocus={(i) => onFocus(i)}>
          ...
          <TabContaier sectionName={"Sell to Anyone"}>
            ...
            >
              <SellToAllForm setValue={setValue} alias={alias} />
            </ModalBody>
          </TabContaier>
        </TabulationBody>
      </>
