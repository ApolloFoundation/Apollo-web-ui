...
import AcceptInformation from './marketplace/accept-information/';
// Messenger
        ...
        return (
            ...
            >
                <ModalProvider>
                    ...
                    {this.props.modalType === 'MARKETPLACE_ACCEPT_INFO'     && <AcceptInformation         closeModal={this.closeModal} nameModal={'MARKETPLACE_ACCEPT_INFO'}/>}
