...
import SmartContractsExplorer from './smart-contract-explorer';
// Voting system
        ...
        return (
            ...
            >
                <ModalProvider>
                    ...
                    {this.props.modalType === 'SMC_EXPLORER'                && <SmartContractsExplorer      closeModal={this.closeModal} nameModal={'SMC_EXPLORER'}/>}
