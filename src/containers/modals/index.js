...
import AproveToken from './smart-contract/aprove-token'
        ...
        return (
            ...
            >
                <ModalProvider>
                    ...
                    {this.props.modalType === 'SMC_APROVE_TOKEN'            && <AproveToken               closeModal={this.closeModal} nameModal={'SMC_APROVE_TOKEN'}/>}
