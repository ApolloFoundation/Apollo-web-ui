...
class AddMonitoredAccount extends React.Component {
  handleFormSubmit = async (values) => {
    ...
    this.props.submitForm(values, "setAccountProperty").then((data) => {
      console.log(data);
    });
  };
              ...
              <div className="form-group-app">
                ...
                <div className="input-group-app offset-top display-block inline">
                  <div className="row">
                    ...
                    <div className="col-md-9">
                      <div className="input-wrapper">
                        <Text field={"amount"} placeholder={"Amount"} />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="input-group-app offset-top display-block inline">
                  <div className="row">
                    ...
                    <div className="col-md-9">
                      <div className="input-wrapper">
                        <Text field={"threshold"} placeholder={"Threshold"} />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="input-group-app offset-top display-block inline">
                  <div className="row">
                    ...
                    <div className="col-md-9">
                      <div className="input-wrapper">
                        <Text field={"interval"} placeholder={"Interval"} />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="input-group-app offset-top display-block inline">
                  <div className="row">
                    ...
                    <div className="col-md-9">
                      <div className="input-wrapper">
                        <Text field={"feeAPL"} placeholder={"Amount"} />
                      </div>
                    </div>
                  </div>
                </div>
