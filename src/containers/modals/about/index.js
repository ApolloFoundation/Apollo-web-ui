                ...
                <div className="about">
                    ...
                    <div className="right-bar">
                        <div className="description">
                            <p>Utilizing a team of world-class developers, managers, marketers, and researchers, the Apollo Foundation has set out to accomplish the vision of making Apollo the most technologically advanced, feature-rich, un-regulatable currency on Earth. We know the demands of a top-tier cryptocurrency, and we believe we can create a coin that will integrate everything necessary to rise above the rest. As we develop and improve Apollo, our team will strive to continue designing and developing features that have not previously been used in cryptocurrency.</p>
